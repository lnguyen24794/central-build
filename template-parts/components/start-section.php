...
<section class="about-two-hero-section">
    <div class="w-layout-blockcontainer container-one about-two-hero-container w-container">
        <div data-w-id="63eda76c-1eca-a647-61b0-147677936d70" class="w-layout-hflex left-container">
            ...
            <h1 class="text-white margin-none about-two-hero-heading animate__animated animate__bounceInRight">
                <?php
                $hero_title = get_option('central_build_hero_title', __('Your Commercial Fitout, Made Simple', 'central-build'));
                echo esc_html($hero_title);
                ?>
            </h1>
            
            <p class="margin-top-twenty paragraph-box-container animate__animated animate__bounceInRight">
                <?php
                $hero_description = get_option(
            ...
            <?php
            $hero_button_text = get_option('central_build_hero_button_text', __('Start Your Fitout Journey', 'central-build'));
                $hero_button_subtext = get_option('central_build_hero_button_subtext', __('Learn more', 'central-build'));
                $hero_button_url = get_option('central_build_hero_button_url', home_url('/commercial-shop-fitting'));
                ?>
            <a href="<?php echo esc_url($hero_button_url); ?>" role="button" class="hero-button-2 hero-button-here w-inline-block animate__animated animate__bounceInUp">
