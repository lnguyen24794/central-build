...
<section class="about-one-section-four">
    <div class="w-layout-blockcontainer life-to-vision-container w-container">
        ...
        <!-- Section Header -->
        <div data-w-id="0e331148-2df2-4cc1-ea98-909bd35be7ea" class="w-layout-vflex helping-flex left-align" data-aos="fade-down" data-aos-duration="1000">
        ...
        <div class="w-layout-hflex about-one-focused-block">
            ...
            <!-- Left - Process Steps -->
            <div class="about-one-focused-left" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
            ...
            <div class="about-one-focused-right" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="400">
                <?php
        ...
        <!-- Statistics Counter -->
        <div class="w-layout-hflex about-one-counter-block" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600">
